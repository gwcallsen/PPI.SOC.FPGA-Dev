...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\gcallsen\Documents\GitHub\IRAIL-1.6-FPGA\synthesis\rev_9\m2s010_som.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\gcallsen\Documents\GitHub\IRAIL-1.6-FPGA\constraint\io\m2s010_som.io.pdc"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\gcallsen\Documents\GitHub\IRAIL-1.6-FPGA\designer\m2s010_som} \
    -design m2s010_som \
    -fam SmartFusion2 \
    -die PA4M6000 \
    -pkg fcs325 \
    -pdc_file {C:\Users\gcallsen\Documents\GitHub\IRAIL-1.6-FPGA\constraint\io\m2s010_som.io.pdc} \
    -merge_pdc 0
